  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        maxHeight: '90vh',
        overflowY: 'auto',
        background: 'linear-gradient(135deg, rgba(0, 0, 0, 0.95) 0%, rgba(74, 144, 217, 0.1) 100%)',
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
            ...
            <button
              ...
              style={{
                ...
                padding: '1rem',
                borderRadius: '12px',
                background: submitting ? 'rgba(74, 144, 217, 0.5)' : 'linear-gradient(135deg, #4A90D9 0%, #2563EB 100%)',
                border: 'none',
                color: '#000000',
                fontSize: '1rem',
                fontWeight: '600',
