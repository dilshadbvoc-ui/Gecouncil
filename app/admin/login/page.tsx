...
export default function AdminLogin() {
  ...
  const inputStyle: React.CSSProperties = {
    ...
    borderRadius: '12px', border: '1px solid rgba(74,144,217,0.3)',
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#000000', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '1rem' }}>
      <div style={{
        ...
        border: '1px solid rgba(74,144,217,0.3)', backdropFilter: 'blur(20px)',
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          ...
          />
          <h1 style={{ fontSize: '1.875rem', fontWeight: '700', color: '#4A90D9', marginBottom: '0.5rem', fontFamily: 'Playfair Display, serif' }}>
            Admin Login
          </h1>
        ...
        <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
          ...
          <div>
            ...
            <div style={{ position: 'relative' }}>
              <Mail style={{ position: 'absolute', left: '1rem', top: '50%', transform: 'translateY(-50%)', width: '18px', height: '18px', color: '#4A90D9' }} />
          ...
          <div>
            ...
            <div style={{ position: 'relative' }}>
              <Lock style={{ position: 'absolute', left: '1rem', top: '50%', transform: 'translateY(-50%)', width: '18px', height: '18px', color: '#4A90D9' }} />
          ...
          <button type="submit" disabled={loading} style={{
            ...
            background: loading ? 'rgba(74,144,217,0.5)' : 'linear-gradient(135deg, #4A90D9 0%, #2563EB 100%)',
