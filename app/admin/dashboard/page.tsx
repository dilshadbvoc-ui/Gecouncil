...
export default function AdminDashboard() {
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: '0.75rem', fontWeight: '600', color: 'rgba(248,249,250,0.4)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '1rem' }}>
        Manage Content
      </p>
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(230px, 1fr))', gap: '1rem' }}>
        {sections.map(({ href, label, color, desc, Icon }) => (
          <Link key={href + label} href={href} style={{ textDecoration: 'none' }}>
            <div style={{ padding: '1.5rem', borderRadius: '14px', background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.07)', cursor: 'pointer', display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                ...
                <ArrowRight size={16} color="rgba(248,249,250,0.3)" />
              </div>
              <div>
