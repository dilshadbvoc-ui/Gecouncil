    ...
    <div style={{ minHeight: '100vh', background: '#000000', color: '#F8F9FA' }}>
      ...
      <div style={{ padding: '2rem' }}>
        ...
        <div style={{
          ...
          {loading ? (
            <div style={{ padding: '3rem', textAlign: 'center', color: '#D4AF37' }}>
              ...
              <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                <thead>
                  <tr style={{ borderBottom: '1px solid rgba(212, 175, 55, 0.2)', background: 'rgba(212, 175, 55, 0.05)' }}>
                    <th style={{ padding: '1rem', textAlign: 'left', color: '#D4AF37', fontWeight: '600' }}>Flag</th>
                    <th style={{ padding: '1rem', textAlign: 'left', color: '#D4AF37', fontWeight: '600' }}>Name</th>
                    <th style={{ padding: '1rem', textAlign: 'left', color: '#D4AF37', fontWeight: '600' }}>Location</th>
                    <th style={{ padding: '1rem', textAlign: 'left', color: '#D4AF37', fontWeight: '600' }}>Country</th>
                    <th style={{ padding: '1rem', textAlign: 'center', color: '#D4AF37', fontWeight: '600' }}>Programs</th>
                    <th style={{ padding: '1rem', textAlign: 'center', color: '#D4AF37', fontWeight: '600' }}>Rating</th>
                ...
                <tbody>
                  {filteredUniversities.map((uni) => (
                    <tr key={uni.id} style={{ borderBottom: '1px solid rgba(255, 255, 255, 0.05)' }}>
                      ...
                      <td style={{ padding: '1rem', textAlign: 'center', color: '#D4AF37', fontWeight: '600' }}>{uni.rating}</td>
