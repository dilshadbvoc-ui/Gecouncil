      ...
      <div style={{ paddingTop: '80px' }}>
        ...
        <section style={{
          ...
          <p style={{
            ...
            Bridging the gap between talented graduates and leading employers across India and Europe.
          </p>
        </section>
        ...
        <section style={{ padding: '4rem 2rem', maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{
            ...
            {['Campus Recruitment', 'Industry Partnerships', 'Career Counselling', 'Placement Support'].map((item) => (
              <div key={item} style={{
                padding: '2rem',
                borderRadius: '16px',
                ...
                <p style={{ fontSize: '0.9rem', color: 'rgba(248, 249, 250, 0.6)', lineHeight: '1.6' }}>
                  Connecting the right talent with the right opportunities across borders.
                </p>
              </div>
            ))}
          </div>
